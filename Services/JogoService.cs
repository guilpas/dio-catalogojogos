using CatalogoJogosDIO_API.Entities;
using CatalogoJogosDIO_API.Exceptions;
using CatalogoJogosDIO_API.InputModel;
using CatalogoJogosDIO_API.Repositories;
using CatalogoJogosDIO_API.ViewModel;

namespace CatalogoJogosDIO_API.Services;
